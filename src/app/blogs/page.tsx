...
export const metadata: Metadata = {
  ...
  description: "Read the latest articles and insights from AIMS Training Center. Stay informed about professional training trends and career development in the Abu Dhabi.",
  openGraph: {
